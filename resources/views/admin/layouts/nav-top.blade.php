    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="{{ url('/') }}">
                <img src="{{URL::asset('admin/img/brand/logo.png')}}" class="header-brand-img desktop-lgo" alt="Polly logo" style="width:80px;margin-left:-50px">
                <img src="{{URL::asset('admin/img/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="Polly logo">
            </a>
                ...
                <div class="dropdown profile-dropdown">
                    <a href="#" class="nav-link" data-bs-toggle="dropdown">
                        <span class="float-right">
                            <img src="{{ URL::asset('admin/img/users/avatar.jpg') }}"
                                alt="img" class="avatar avatar-md">
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        <div class="text-center pt-2">
                            <span class="text-center user fs-12 pb-0 font-weight-bold"> 
                                @if(Auth::check())
