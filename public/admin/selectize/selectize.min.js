...
(function(root, factory) {
  ...
  var highlight = function(t, e) {
      ...
      if ("string" != typeof e || e.length)
        return (r =
          "string" == typeof e ? new RegExp(e, "i") : e), (a = function(t) {
          var e = 0;
          if (3 === t.nodeType) {
            var n,
              i,
    ...
    MicroPlugin = (
      (MicroEvent.prototype = {
        on: function(t, e) {
          (this._events = this._events || {}), (this._events[t] =
    ...
    utils = (
      (MicroPlugin.mixin = function(o) {
        (o.plugins = {}), (o.prototype.initializePlugins = function(t) {
          ...
          (n.requested[t] = !0), (n.loaded[t] = i.fn.apply(e, [
    ...
    cmp = (
      ...
      (Sifter.prototype.search = function(t, n) {
        ...
        return (n = s.options), (t = s.query), (o =
          n.score || e.getScoreFunction(s)), t.length
          ? e.iterator(e.items, function(t, e) {
              (i = o(
                t
              )), (!1 === n.filter || 0 < i) && s.items.push({ score: i, id: e });
            })
          : e.iterator(e.items, function(t, e) {
              s.items.push({ score: 1, id: e });
            }), (t = e.getSortFunction(s, n)) && s.items.sort(t), (s.total =
          s.items.length), "number" == typeof n.limit &&
          (s.items = s.items.slice(0, n.limit)), s;
      }),
      function(t, e) {
  ...
  var IS_MAC = uaDetect("macOS", /Mac/),
    ...
    logError = function(t, e) {
      e = e || {};
      console.error("Selectize: " + t), e.explanation &&
        (
    ...
    Selectize = function(t, e) {
      ...
      (o.settings.mode =
        o.settings.mode ||
        (1 === o.settings.maxItems ? "single" : "multi")), "boolean" !=
        typeof o.settings.hideSelected &&
        (o.settings.hideSelected =
          "multi" === o.settings.mode), o.initializePlugins(
        o.settings.plugins
      ), o.setupCallbacks(), o.setupTemplates(), o.setup();
    };
  MicroEvent.mixin(
    Selectize
  ), MicroPlugin.mixin(Selectize), $.extend(Selectize.prototype, {
    setup: function() {
      var e = this,
        t = e.settings,
        n = e.eventNS,
        ...
        p = $("<div>")
          ...
          .appendTo(l),
        c = $(
          '<input type="select-one" autocomplete="off" autofill="no" />'
        )
          .appendTo(p)
        ...
        d = (
          ...
          o.on("keydown" + n, function(t) {
            (e.isCmdDown =
              t[
                IS_MAC ? "metaKey" : "ctrlKey"
              ]), (e.isCtrlDown = t[IS_MAC ? "altKey" : "ctrlKey"]), (e.isShiftDown = t.shiftKey);
          }),
          o.on("keyup" + n, function(t) {
            t.keyCode === KEY_CTRL &&
              (e.isCtrlDown = !1), t.keyCode === KEY_SHIFT && (e.isShiftDown = !1), t.keyCode === KEY_CMD && (e.isCmdDown = !1);
          }),
      ...
      s.replaceWith(d), d.replaceWith(s), (this.revertSettings = {
      ...
      }), s.attr("tabindex", -1).hide().after(e.$wrapper), Array.isArray(
        t.items
      ) &&
        (
        ...
        }), e.updateOriginalInput(), e.refreshItems(), e.refreshState(), e.updatePlaceholder(), (e.isSetup = !0), s.is(
        ":disabled"
      ) && e.disable(), e.on("change", this.onChange), s.data(
        "selectize",
        e
      ), s.addClass("selectized"), e.trigger("initialize"), !0 === t.preload &&
        e.onSearchChange("");
    },
    ...
    onChange: function() {
      "" !== this.getValue() &&
        (this.lastValidValue = this.getValue()), this.$input.trigger(
        "input"
        ...
        : o.settings.splitOn &&
          setTimeout(function() {
            ...
            if (t.match(o.settings.splitOn))
              for (
                var e = t.trim().split(o.settings.splitOn), n = 0, i = e.length;
                n < i;
                n++
              )
                o.createItem(e[n]);
          ...
          case KEY_DOWN:
            return !n.isOpen && n.hasOptions
              ...
              : n.$activeOption &&
                ...
                n.setActiveOption(e, !0, !0), void t.preventDefault();
          case KEY_P:
            if (!t.ctrlKey || t.altKey) break;
          case KEY_UP:
            return n.$activeOption &&
              (
                (n.ignoreHover = !0),
                (e = n.getAdjacentOption(n.$activeOption, -1)).length
              ) &&
      ...
      i.isFocused &&
        (
          ...
          i.ignoreFocus ||
            (
              (n = function() {
                i.close(), i.setTextboxValue(""), i.setActiveItem(
                  null
                ), i.setActiveOption(null), i.setCaret(
                  i.items.length
                ), i.refreshState(), e &&
                  e.focus &&
                  e.focus(), (i.isBlurring = !1), (i.ignoreFocus = !1), i.trigger(
                  "blur"
                );
              }),
              (i.isBlurring = !0),
    ...
    onOptionSelect: function(t) {
      var e,
        n = this;
      t.preventDefault && (t.preventDefault(), t.stopPropagation()), (e = $(
        t.currentTarget
      )).hasClass("create")
    ...
    load: function(t) {
      ...
      e.loading++, t.apply(e, [
        function(t) {
          (e.loading = Math.max(e.loading - 1, 0)), t &&
            t.length &&
            (
              e.addOption(t),
              e.refreshOptions(e.isFocused && !e.isInputHidden)
            ), e.loading || n.removeClass(e.settings.loadingClass), e.trigger(
            "load",
            t
          );
        }
    ...
    setMaxItems: function(t) {
      (this.settings.maxItems = t = 0 === t ? null : t), (this.settings.mode =
        this.settings.mode ||
        (1 === this.settings.maxItems
          ? "single"
          : "multi")), this.refreshState();
    },
        ...
        if ((t = $(t)).length) {
          if (
            ...
            for (
              ...
              (s = l.$control[0].childNodes[i]), -1 ===
                l.$activeItems.indexOf(s) &&
          ...
          $(l.$activeItems).removeClass(
            "active"
          ), (l.$activeItems = []), l.isFocused && l.showInput();
    },
    setActiveOption: function(t, e, n) {
      ...
      a.$activeOption &&
        ...
        ), (a.$activeOption = null), (t = $(t)).length &&
        (
    ...
    refreshOptions: function(t) {
      ...
      for (
        "number" == typeof g.settings.maxOptions &&
          (w = Math.min(w, g.settings.maxOptions)), o = {}, s = [], e = 0;
        e < w;
        e++
      )
        for (
          r = g.options[v.items[e].id], a = g.render("option", r), O =
            r[g.settings.optgroupField] || "", n = 0, i =
            (l = Array.isArray(O) ? O : [O]) && l.length;
          n < i;
          n++
        ) {
          var C,
          ...
          g.optgroups.hasOwnProperty(O) ||
            ...
            ((C = g.settings.optionGroupRegister.apply(g, [O])) &&
              g.registerOptionGroup(C)), g.optgroups.hasOwnProperty(O) ||
            (O = ""), o.hasOwnProperty(O) ||
            ((o[O] = document.createDocumentFragment()), s.push(O)), o[
            O
          ].appendChild(a);
        }
      for (
        this.settings.lockOptgroupOrder &&
          ...
          }), p = document.createDocumentFragment(), e = 0, w = s.length;
        e < w;
        e++
      )
      ...
      if (!g.settings.hideSelected)
        for (
          g.$dropdown.find(".selected").removeClass("selected"), e = 0, w =
            g.items.length;
          e < w;
          e++
        )
      ...
      "auto" !== g.settings.dropdownSize.sizeType &&
        g.isOpen &&
        g.setupDropdownHeight(), (u = g.canCreate(f)) &&
        ...
        g.settings.setFirstOptionActive), g.hasOptions
        ? (
            0 < v.items.length
              ? (
                  (f = y && g.getOption(y)),
    ...
    addOptionGroup: function(t, e) {
      (e[this.settings.optgroupValueField] = t), (t = this.registerOptionGroup(
        e
    ...
    clearOptionGroups: function() {
      (this.optgroups = {}), (this.renderCache = {}), this.trigger(
        "optgroup_clear"
      );
    },
    updateOption: function(t, e) {
      ...
      if (
        ...
        (o = s.options[t].$order), n !== t &&
          ...
          s.items.splice(i, 1, n), (e.$order = e.$order || o), (s.options[
          n
        ] = e), (i = s.renderCache.item), (o = s.renderCache.option), i &&
          (delete i[t], delete i[n]), o && (delete o[t], delete o[n]), -1 !==
          s.items.indexOf(n) &&
          (
            (i = s.getItem(t)),
            (o = $(s.render("item", e))),
            ...
            i.replaceWith(o)
          ), (s.lastQuery = null), s.isOpen && s.refreshOptions(!1);
      }
    },
    removeOption: function(t, e) {
      ...
      i && delete i[t], o && delete o[t], delete n.userOptions[t], delete n
        .options[t], (n.lastQuery = null), n.trigger(
        "option_remove",
        t
      ), n.removeItem(t, e);
    },
    clearOptions: function(t) {
      ...
      }), (n.options = n.sifter.items = i), (n.lastQuery = null), n.trigger(
        "option_clear"
      ), n.clear(t);
    },
          ...
          "function" == typeof i.settings.create
            ...
            : function(t) {
                ...
                if (
                  ...
                  (null != (t = i.settings.formatValueToKey.apply(this, [t])) &&
                    "object" != typeof t &&
                    "function" != typeof t)
                )
    ...
    refreshItems: function(t) {
      (this.lastQuery = null), this.isSetup &&
        this.addItem(
          this.items,
          t
        ), this.refreshState(), this.updateOriginalInput({ silent: t });
    },
    ...
    refreshValidityState: function() {
      ...
      (this.isInvalid = t), this.$control_input.prop(
        "required",
        t
    ...
    refreshClasses: function() {
      var t = this,
        e = t.isFull(),
        n = t.isLocked;
      t.$wrapper.toggleClass("rtl", t.rtl), t.$control
        ...
        .toggleClass("has-items", 0 < t.items.length), t.$control_input.data(
        "grow",
        !e && !n
      );
    },
      ...
      (t = t || {}), a.tagType === TAG_SELECT
        ? (
            ...
            a.items.forEach(function(t) {
              (s =
                a.options[t][a.settings.labelField] ||
                ""), r.push(t), -1 == e.indexOf(t) && n.push('<option value="' + escape_html(t) + '" selected="selected">' + escape_html(s) + "</option>");
            }),
            (i = e
              .filter(function(t) {
    ...
    close: function() {
      ...
      "single" === t.settings.mode &&
        ...
        t.$control_input[0].blur(), (t.isOpen = !1), t.$dropdown.hide(), t.setActiveOption(
        null
      ), t.refreshState(), e && t.trigger("dropdown_close", t.$dropdown);
    },
    positionDropdown: function() {
      ...
      this.settings.minWidth &&
        ...
        (t = this.settings.minWidth), this.$dropdown.css({
        width: t,
        top: e.top,
        left: e.left
      });
      ...
      if (
        ...
        if ("numberItems" === this.settings.dropdownSize.sizeType) {
          for (
            ...
            var a = $(e[r]);
            if (0 === a.length) break;
            (n += a.outerHeight(!0)), void 0 === a.data("selectable") &&
              (
    ...
    insertAtCaret: function(t) {
      ...
      0 === e
        ...
        : n.insertBefore(t, n.childNodes[e]), this.setCaret(e + 1);
    },
    deleteSelection: function(t) {
      ...
      if (
        (
          r.$activeOption &&
            ...
            (o = ("string" == typeof r.settings.deselectBehavior &&
            "top" === r.settings.deselectBehavior
              ? r.getFirstOption()
              : r.getAdjacentOption(r.$activeOption, -1)).attr("data-value")),
          (i = []),
        ...
        for (
          ...
          ), s = r.$control.children(":not(input)").index(s), 0 < a &&
            s++, e = 0, n = r.$activeItems.length;
          e < n;
          e++
        )
      ...
      return r.showInput(), r.positionDropdown(), r.refreshOptions(!0), o &&
        (t = r.getOption(o)).length &&
        r.setActiveOption(t), !0;
    },
    ...
    disable: function() {
      this.$input.prop("disabled", !0), this.$control_input
        .prop("disabled", !0)
        .prop("tabindex", -1), (this.isDisabled = !0), this.lock();
    },
    enable: function() {
      var t = this;
      t.$input.prop("disabled", !1), t.$control_input
        .prop("disabled", !1)
        .prop("tabindex", t.tabIndex), (t.isDisabled = !1), t.unlock();
    },
    destroy: function() {
      var t = this,
        e = t.eventNS,
      ...
      t.trigger(
        "destroy"
      ), t.off(), t.$wrapper.remove(), t.$dropdown.remove(), t.$input
        .html("")
        .append(n.$children)
        .removeAttr("tabindex")
        .removeClass("selectized")
        .attr({ tabindex: n.tabindex })
        .show(), t.$control_input.removeData("grow"), t.$input.removeData(
        "selectize"
      ), 0 == --Selectize.count &&
        Selectize.$testInput &&
        (Selectize.$testInput.remove(), (Selectize.$testInput = void 0)), $(
        window
      ).off(e), $(document).off(e), $(document.body).off(e), delete t.$input[0]
        .selectize;
    },
    render: function(t, e) {
      var n,
      ...
      function e(t, e) {
        ...
        (i || v.allowEmptyOption) &&
          (l.hasOwnProperty(i)
            ? e &&
              ((n = l[i][O])
                ? Array.isArray(n) ? n.push(e) : (l[i][O] = [n, e])
                : (l[i][O] = e))
            : (
                ((n = p(t) || {})[y] = n[y] || t.text()),
                (n[w] = n[w] || i),
        ...
        p = function(t) {
          ...
          return "string" == typeof e &&
            ...
            (isJSON(e)
              ...
              : (n[e] = e)), Object.assign(n, t), n || null;
        };
      for (
        o.maxItems = t.attr("multiple")
          ? null
          : 1, n = 0, i = (r = t.children()).length;
        n < i;
        n++
      )
    ...
    Selectize.defaults), ($.fn.selectize.support = { validity: SUPPORTS_VALIDITY_API }), Selectize.define(
    "auto_position",
    function() {
    ...
    i.onBlur = (
      ...
      function(t) {
        ...
        return void 0 !== e.attr("data-value") &&
          i.getValue() !== e.attr("data-value") &&
          i.setValue(e.attr("data-value")), n.apply(this, arguments);
      }
    );
    ...
    (e = $.extend(
      ...
      (t = n.setup),
      function() {
        t.apply(n, arguments), (n.$button_clear = $(e.html(e))), "single" ===
          n.settings.mode && n.$wrapper.addClass("single"), n.$wrapper.append(
          n.$button_clear
        ), ("" !== n.getValue() && 0 !== n.getValue().length) ||
          n.$wrapper
            .find("." + e.className)
            .css("display", "none"), n.on("change", function() {
          "" === n.getValue() || 0 === n.getValue().length
        ...
        (i.setup = (
          ...
          function() {
            ...
            var n = i.$control.sortable({
              ...
              disabled: i.isLocked,
              start: function(t, e) {
                e.placeholder.css("width", e.helper.css("width")), n.addClass(
                  "dragging"
                );
              },
              stop: function() {
                ...
                }), (i.isFocused = !1), i.setValue(
                  e
                ), (i.isFocused = !0), i.setActiveItem(t), i.positionDropdown();
              }
            });
          }
        ))
    ...
    (t = $.extend(
      ...
      (e = n.setup),
      function() {
        e.apply(n, arguments), (n.$dropdown_header = $(
          t.html(t)
        )), n.$dropdown.prepend(n.$dropdown_header), n.$dropdown_header
          .find("." + t.closeClass)
          .on("click", function() {
            n.close();
          });
      ...
      l = (
        ...
        (this.onKeyDown = (
          ...
          function(t) {
            ...
            (a.ignoreHover = !0), (e = (n = this.$activeOption.closest(
              "[data-group]"
            ))
              .find("[data-selectable]")
              .index(this.$activeOption)), (n = (n = (n =
              t.keyCode === KEY_LEFT
                ? n.prev("[data-group]")
            ...
            e.append &&
              (
                ...
                (i.settings.render.item = function(t) {
                  return (e = o.apply(s, arguments)), (n = r), (i = e.search(
                    /(<\/[^>]+>\s*)$/
                  )), e.substring(0, i) + n + e.substring(i);
                  var e, n, i;
                })
              ), n.apply(s, arguments), s.$control.on(
              "click",
              "." + e.className,
              function(t) {
                if ((t.preventDefault(), !i.isLocked))
                  return (t = $(t.currentTarget).parent()), i.setActiveItem(
                    t
                  ), i.deleteSelection() && i.setCaret(i.items.length), !1;
              }
            );
          }
        ))
    ...
    (n.text =
      ...
      function(t) {
        ...
        if (
          ...
          return i.apply(this, arguments);
        (e = this.options[this.items[e]]), this.deleteSelection(t) &&
          (
    ...
    i.on(
      ...
      (
        ...
        function(t) {
          ...
          return i.clear(), i.setTextboxValue(
            e
          ), i.$control_input.select(), setTimeout(function() {
      ...
      function(t) {
        return "" === i.getValue() &&
          ...
          i.setValue(i.lastValidValue), setTimeout(function() {
    ...
    (o.tagLimit = o.tagLimit), (this.onBlur = (function() {
      ...
      return function(t) {
        e.apply(this, t), t &&
          ((t = this.$control).find(".item").show(), t.find("span").remove());
      };
    })());
  });
  return Selectize;
